#!/bin/bash	
#SBATCH --job-name=hepmass_maf_full
#SBATCH --account dd-23-138
#SBATCH --output=hepmass_maf_full-%J.log
...
python main_trainer_uci.py --multirun dataset=hepmass_maf base_distribution=proposal proposal=gaussian_full \
