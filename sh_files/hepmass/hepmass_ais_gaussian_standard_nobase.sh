#!/bin/bash	
#SBATCH --job-name=hepmass_maf_nobase
#SBATCH --account dd-23-138
#SBATCH --output=hepmass_maf_nobase-%J.log
...
python main_trainer_uci.py --multirun dataset=hepmass_maf base_distribution=no_base_distribution proposal=gaussian \
