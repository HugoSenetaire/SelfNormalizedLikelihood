#!/bin/bash	
#SBATCH --job-name=power_maf_full_no_base
#SBATCH --account dd-23-138
#SBATCH --output=power_maf_full_no_base-%J.log
...
python main_trainer_uci.py --multirun dataset=power_maf base_distribution=no_base_distribution proposal=gaussian_full \
