#!/bin/bash	
#SBATCH --job-name=power_maf_full
#SBATCH --account dd-23-138
#SBATCH --output=power_maf_full-%J.log
...
python main_trainer_uci.py --multirun dataset=power_maf base_distribution=proposal proposal=gaussian_full \
