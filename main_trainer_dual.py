...
from Model.Trainer import dic_trainer_dual
from Model.Utils.Callbacks import EMA
from Model.Utils.dataloader_getter import get_dataloader
from Model.Utils import get_model_distribution_estimation_dual
...
if __name__ == "__main__":
    ...
    ebm = get_model_distribution_estimation_dual(args_dict, complete_dataset, complete_masked_dataset, loader_train=train_loader)

    # Get Trainer :
    algo = dic_trainer_dual[args_dict["trainer_name"]](
        ebm=ebm,
        args_dict=args_dict,
