...
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_1.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
...
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_8.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
Model/YAMLREGRESSION/YAMLBASEDIST/proposal.yaml \
Model/YAMLREGRESSION/YAMLENERGY/energy_fc_large_bias.yaml Model/YAMLREGRESSION/YAMLOPTIMIZATION/adam1e-3.yaml
...
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_16.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
Model/YAMLREGRESSION/YAMLBASEDIST/proposal.yaml \
Model/YAMLREGRESSION/YAMLENERGY/energy_fc_large_bias.yaml Model/YAMLREGRESSION/YAMLOPTIMIZATION/adam1e-3.yaml
...
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_32.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
Model/YAMLREGRESSION/YAMLBASEDIST/proposal.yaml \
Model/YAMLREGRESSION/YAMLENERGY/energy_fc_large_bias.yaml Model/YAMLREGRESSION/YAMLOPTIMIZATION/adam1e-3.yaml
...
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_64.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
Model/YAMLREGRESSION/YAMLBASEDIST/proposal.yaml \
Model/YAMLREGRESSION/YAMLENERGY/energy_fc_large_bias.yaml Model/YAMLREGRESSION/YAMLOPTIMIZATION/adam1e-3.yaml
...
CUDA_VISIBLE_DEVICES=6 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_trainfeatureextractor' --train_feature_extractor--output_folder '/scratch/hhjs/selfnormalized/Results_trainfeatureextractor' --train_feature_extractor  \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
--yamlebm Model/YAMLREGRESSION/YAMLEBM_AblationTrainingSamples/self_normalized_128.yaml Model/YAMLREGRESSION/YAMLPROPOSAL/standard_gaussian.yaml \
Model/YAMLREGRESSION/YAMLBASEDIST/proposal.yaml \
Model/YAMLREGRESSION/YAMLENERGY/energy_fc_large_bias.yaml Model/YAMLREGRESSION/YAMLOPTIMIZATION/adam1e-3.yaml
