...
CUDA_VISIBLE_DEVICES=2 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining' --ebm_pretraining standard_gaussian \
