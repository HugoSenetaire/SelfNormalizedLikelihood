...
CUDA_VISIBLE_DEVICES=4 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining' --ebm_pretraining standard_gaussian --proposal_pretraining data --proposal_pretraining data \
...
CUDA_VISIBLE_DEVICES=4 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining' --ebm_pretraining standard_gaussian --proposal_pretraining data \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
...
# Log prob test
CUDA_VISIBLE_DEVICES=5 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining' --ebm_pretraining standard_gaussian --proposal_pretraining data \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
...
# NCE Test
CUDA_VISIBLE_DEVICES=6 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining' --ebm_pretraining standard_gaussian --proposal_pretraining data \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
