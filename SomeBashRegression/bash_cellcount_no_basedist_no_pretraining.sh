...
CUDA_VISIBLE_DEVICES=1 python main_trainer_regression.py --ebm_pretraining standard_gaussian \
...
# Log prob test
CUDA_VISIBLE_DEVICES=2 python main_trainer_regression.py --ebm_pretraining standard_gaussian \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
...
# NCE Test
CUDA_VISIBLE_DEVICES=3 python main_trainer_regression.py --ebm_pretraining standard_gaussian \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
