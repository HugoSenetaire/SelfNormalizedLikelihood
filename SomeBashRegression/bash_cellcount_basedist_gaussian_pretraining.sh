...
CUDA_VISIBLE_DEVICES=1 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining'  --proposal_pretraining data --proposal_pretraining data \
...
CUDA_VISIBLE_DEVICES=1 python main_trainer_regression.py --output_folder '/scratch/hhjs/selfnormalized/Results_pretraining'  --proposal_pretraining data \
--yamldataset 'Dataset/MissingDataDataset/YAMLExamples/cell_count.yaml' \
