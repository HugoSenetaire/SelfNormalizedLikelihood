...
def get_EnergyNetworkRegression_Large(input_size_x_feature, input_size_y, cfg):
    return EnergyNetworkRegression_Large(input_size_x_feature,
                            input_size_y,
                            )

def get_EnergyNetworkRegression_Toy(input_size_x_feature, input_size_y, cfg):
    return EnergyNetworkRegression_Toy(input_size_x_feature,
                            input_size_y,
                            )
