...
def default_args_ebm(parser=None):
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="*",
        help="YAML File path to override the EBM parameters",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=512,
        help="Standard deviation of the proposal",
    )
    parser.add_argument(
        "--num_sample_proposal_val",
        type=float,
        default=1024,
        help="Standard deviation of the proposal",
    )
    parser.add_argument(
        "--num_sample_proposal_test",
        type=float,
        default=20000,
        help="Standard deviation of the proposal",
    )
    ...
    parser.add_argument(
        "--train_proposal", action="store_true", help="Train the proposal"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--train_base_dist", type=bool, default=True, help="Train the base distribution"
    )
    parser.add_argument(
        "--proposal_loss_name",
        type=str,
        default="log_prob",
        choices=["log_prob", "kl", "log_prob_kl"],
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Choose what type of pretraining is done on the network",
    )
    parser.add_argument(
        "--proposal_pretraining",
        type=str,
        default=None,
        help="Choose what type of pretraining is done on the network",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="none",
        help="Base distribution to multiply the energy with",
        choices=["none", "Normal", "proposal"],
    )
    ...
    parser.add_argument(
        "--load_from_checkpoint", action="store_true", help="Load from checkpoint"
    )
    ...
    parser.add_argument(
        "--dataloader_name", type=str, default="default", help="Name of the dataloader"
    )
    parser.add_argument(
        "--decay_ema", type=float, default=None, help="Decay of the EMA"
    )  # reg 0.999
